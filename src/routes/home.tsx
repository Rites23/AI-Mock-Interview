    ...
    <div className="flex-col w-full pb-24">
      <Container>
        ...
        <div className="flex w-full items-center justify-evenly md:px-12 md:py-16 md:items-center md:justify-end gap-12">
          ...
          <p className="text-3xl font-semibold text-gray-900 text-center">
            1.2M+
            <span className="block text-xl text-muted-foreground font-normal">Interview Aced</span>
          </p>
        </div>
        <div className="w-full mt-4 rounded-xl bg-gray-100 h-[420px] drop-shadow-md overflow-hidden relative">
          ...
          <div className="hidden md:block absolute w-80 bottom-4 right-4 px-4 py-2 rounded-md bg-white/60 backdrop-blur-md">
            ...
            <p className="text-sm text-neutral-500">
              Ready to ace your next interview? Instantly generate realistic, AI-powered mock interview questions and answers tailored to your dream job. Click below to get started!
            </p>
            <Link to="/generate">
